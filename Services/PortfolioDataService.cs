    ...
    public static class PortfolioDataService
    {
        private static readonly List<ProjectItem> _devProjects = new()
        {
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/vero-fintech.svg",
                ImageAlt = "Vero Fintech icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/portico-arquitetura.svg",
                ImageAlt = "Pórtico Arquitetura icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/aura-perfumaria.svg",
                ImageAlt = "Aura Perfumaria icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/kinetika-academia.svg",
                ImageAlt = "Kinetika Academia icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/amaral-prado-advocacia.svg",
                ImageAlt = "Amaral and Prado Advocacia icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/your-rhythm-studio.svg",
                ImageAlt = "YourRhythm Studio icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/axon-design.svg",
                ImageAlt = "Axon Design icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/nitida-diagnostic-design.svg",
                ImageAlt = "NITIDA icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/ambar.svg",
                ImageAlt = "AMBAR icon",
            ...
            new ProjectItem
            {
                ...
                ImagePath = "~/img/ProjectFavicons/solar-real-estate.svg",
                ImageAlt = "SOLAR Real Estate icon",
